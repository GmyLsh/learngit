    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header', models.ImageField(blank=True, null=True, upload_to='user/%Y/%m', verbose_name='头像')),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blog.Category', verbose_name='所属分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
