...
class Goods(models.Model):
    ...
    商品
    """
    category = models.ForeignKey(GoodsCategory, verbose_name="商品类目", on_delete=models.CASCADE, help_text='商品所属类别id')
...
class GoodsImage(models.Model):
    ...
    """
    goods = models.ForeignKey(Goods, verbose_name="商品", related_name="images", on_delete=models.CASCADE, help_text="轮播图所属商品ID")
...
class GoodsBanner(models.Model):
    ...
    """
    goods = models.ForeignKey(Goods, verbose_name="商品", on_delete=models.CASCADE, help_text="轮播图片所属商品ID")
